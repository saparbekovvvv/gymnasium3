(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_e42278._.js", {
...
const DonationContent = ()=>{
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            // Создаем объект, соответствующий IDonation
            const donationData = {
                amount: data.amount,
        ...
        // Добавьте логику для очистки формы или отображения сообщения об успехе
        } catch (error) {
            console.error("Error sending donation:", error);
        // Добавьте логику для отображения сообщения об ошибке
        }
    };
...
//# sourceMappingURL=src_e42278._.js.map