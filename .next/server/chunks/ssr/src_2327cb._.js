...
const api = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].injectEndpoints({
    endpoints: (build)=>({
            ...
            getOlympiansSelection: build.query({
                query: (id)=>({
                        url: `${ENDPOINTS}/students/olymp_categories/${id}`,
                        method: "GET"
                    }),
                providesTags: [
                    "olympians"
...
;
const OlympaidTable = ()=>{
    const { olymp_categories } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$14$2e$2$2e$11_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1_sass$40$1$2e$77$2e$8$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useParams"])();
    const { data, isLoading, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$api$2f$olympians$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGetOlympiansSelectionQuery"])(String(olymp_categories));
    console.log(data);
...
//# sourceMappingURL=src_2327cb._.js.map